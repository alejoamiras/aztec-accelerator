...
**Closed 2026-06-04.** ✅ completed (#284; rc.4 GREEN) — state-proof: a decoupled poller proves the Windows disarm-before-install actually ran (observed a 9-sample absence during install); no prod code touched
