...
**Closed 2026-05-29.** completed — WebDriver flake (ungated update check pops prompt mid-E2E after 1.0.2 shipped) + codex post-1.0.2 hardening (PR #236 + #237 merged); see diagnosis.md + eli5.html
