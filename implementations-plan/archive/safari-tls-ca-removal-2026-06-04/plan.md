...
**Closed 2026-06-05.** ✅ completed (#288; Safari-validated on owner's Mac) — remove the Safari-HTTPS root-CA mint-any-cert primitive (audit HIGH); discarded-CA-key design (keep CA cert, never write ca.key), delete on-disk legacy ca.key on migration
