...
**Closed 2026-06-04.** ✅ completed — post-rc Windows parity: server/Cargo.lock fix (#95), crash-recovery-armed updater-smoke (#96), real-artifact updater-smoke flipped to blocking (#279/#280/#281, proven green on 1.0.4-rc.3) — full mac/Linux parity
