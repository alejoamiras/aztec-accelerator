...
**Closed 2026-05-28.** completed — extended setup-accelerator composite to cover release `build` + `build-headless` + `_e2e-webdriver` (PR #230; validated by 1.0.2-rc.2 dry-run)
