...
**Closed 2026-06-01.** completed — release-time updater gate proven on rc.4/rc.5 + 2 codex audits passed. PRs #241 (decouple from DMG flake + teeth) + #242 (audit hardening: tampered-tarball negative test, notarization checks, exact rerun guard) + #243 (polish) merged. Follow-up (promote update-smoke to release-blocking + Intel DMG check + Linux leg) completed in ci-release-overhaul-2026-06-01
