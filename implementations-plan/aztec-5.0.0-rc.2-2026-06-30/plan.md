...
### P2 — Land the bump PR: native-`bb`-rc.2 e2e **+ the runtime-download gate** + auto-merge
...
### P3 — Redeploy+fund the rc.2 testnet FPC → publish SDK (testnet) → redeploy playground → smoke
